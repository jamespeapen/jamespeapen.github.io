...
My solution, partially inspired by tools like that bring a vim buffer where you
are, was to launch a temporary vim buffer, write in it, and when I save and
